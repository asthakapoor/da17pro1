...
insert into students(student_id,name,age,grade) values(2,'akansha','6','A')
...
insert into hostel(hostel_id,name,room) values(4,'priyadarshini girls hostel',67)
...
select * from girls
insert into girls(girls_id,name,age,hostel_id) values(9,'disha','4',1)
insert into girls(girls_id,name,age,hostel_id) values(4,'priya','8',1)
insert into girls(girls_id,name,age,hostel_id) values(3,'mina','7',1)
